      ...
      <aside style={{ width: "250px", backgroundColor: "#1e40af", color: "white", padding: "2rem 1.5rem", boxShadow: "2px 0 10px rgba(0,0,0,0.1)", transition: "all 0.3s ease" }}>
        ...
        <nav style={{ marginTop: "1rem" }}>
          <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
            ...
            <li style={{ marginBottom: "0.5rem", borderRadius: "6px", overflow: "hidden" }}>
              <Link href="/admin/content/reports" style={{ display: "block", padding: "0.75rem 1rem", textDecoration: "none", color: "#e0f2fe", borderRadius: "6px", transition: "all 0.2s ease", display: "flex", alignItems: "center" }} onMouseEnter={(e) => e.target.style.backgroundColor = "#3b82f6"} onMouseLeave={(e) => e.target.style.backgroundColor = "transparent"}>
                <span style={{ marginRight: "0.75rem", fontSize: "1.1rem" }}>📞</span>
                Edit Report Page
              </Link>
            </li>
